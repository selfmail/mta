...
function DragGhost() {
  ...
  return (
    <div
      className="ghost-node animation-rotation pointer-events-none fixed z-9999 min-w-37.5 -translate-x-1/2 -translate-y-1/2 scale-105 animate-in rounded-lg border border-(--border) bg-(--card-background) p-4 text-center font-medium opacity-95 shadow-2xl"
      style={{
